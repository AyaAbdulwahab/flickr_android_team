              ...
              RichText(
                text: TextSpan(
                  ...
                  children: const <TextSpan>[
                    TextSpan(text: email, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 17.0, color: Colors.black, fontFamily: 'ProximaNova',)),
                    TextSpan(text: '. Please check your', style: TextStyle(fontSize: 17.0,color: Colors.black, fontFamily: 'ProximaNova',)),
