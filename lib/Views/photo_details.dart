...
class _PhotoDetailsState extends State<PhotoDetails> {
  Icon public = Icon(Icons.lock_open_rounded, color: Colors.white,);
  Icon private = Icon(Icons.lock_outline_rounded, color: Colors.white,);
  Icon safe = Icon(Icons.check_circle_outline_rounded, color: Colors.white,);
  Icon unsafe = Icon(Icons.dangerous, color: Colors.white,);
